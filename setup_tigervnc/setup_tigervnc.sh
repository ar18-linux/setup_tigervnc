...
ar18.script.execute_with_sudo cp -f "${script_dir}/vncserver.service" "/etc/systemd/system/vncserver.service"
ar18.script.execute_with_sudo systemctl enable vncserver
