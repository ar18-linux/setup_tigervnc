...
echo "${ar18_sudo_password}" | sudo -Sk cp -f "${script_dir}/vncserver.service" "/etc/systemd/system/vncserver.service"
echo "${ar18_sudo_password}" | sudo -Sk systemctl enable vncserver
